    ...
    return (
        <Wrapper>
            ...
            <div className="flex flex-col gap-4">
                <YouTubePreview
                    videoId="xRDKQic90dE" // 실제 YouTube 비디오 ID로 변경
                ...
                <div className="pt-4 pb-8 px-4 flex flex-col gap-2">
                    <strong className="text-xl line-clamp-2">
                        아이유 예뻐.. 너무너무 예뻐. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure nisi
                        porro, in culpa illo, eaque perferendis quaerat molestias voluptatibus natus, delectus
                        similique. Placeat quos, dolorem sint soluta libero cumque quae?
                    </strong>
                    <p className="opacity-70 line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio non expedita dicta, dolor maiores
                        nobis ut quis alias nemo esse est repellendus dolorum sint ratione rem quibusdam doloribus
